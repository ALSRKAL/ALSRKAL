...
intent(
    ...
    'joke(it|that|)',
    reply(
        'do you now what ? hhhhhhhhhhhhh',
        'what the call man without body and nose ? nobody nose hahahhahaha',
...
intent(
    'how is owner',
    reply(
        'Alsrkal Provide as much detail as possible about experience with common programming language and technology tools software and hardware',
